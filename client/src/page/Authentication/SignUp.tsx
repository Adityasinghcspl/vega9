...
import type { SignUpUserForm } from "../../types/type";
...
const SignUp: React.FC = () => {
  ...
  const onSubmit: SubmitHandler<SignUpUserForm> = async (data) => {
    const formData = new FormData();
    formData.append("name", data.name);
    formData.append("email", data.email);
    formData.append("password", data.password);
    if (data.profile_url && data.profile_url.length > 0) {
      formData.append("profile_url", data.profile_url[0]);
    }
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-4">
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full rounded-lg border bg-transparent py-3 pl-6 pr-10 text-black outline-none focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${
              ...
              <div className="mb-6">
                ...
                <input
                  ...
                  className={`w-full rounded-lg border bg-transparent py-3 pl-6 pr-10 text-black file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:bg-primary file:text-white file:cursor-pointer outline-none focus:border-primary dark:border-form-strokedark dark:bg-form-input dark:text-white dark:focus:border-primary ${
                    errors.profile_url ? "border-red-500" : "border-stroke"
                  }`}
                />
                {errors.profile_url && (
                ...
                {previewImage && (
                  <img
                    src={previewImage}
                    alt="Profile Preview"
                    className="mt-3 h-20 w-20 rounded-full object-cover border border-gray-300 dark:border-gray-700"
                  />
                )}
              </div>
